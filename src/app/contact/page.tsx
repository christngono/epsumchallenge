      ...
      <section className="bg-transparent py-16 px-6 md:px-12">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          <Reveal direction="right">
            ...
            {sent ? (
              <div className="bg-green-50 border border-green-200 rounded-lg p-8 text-center">
                ...
                <h3 className="text-lg font-bold text-[#2A1812] mb-2">Message envoyé !</h3>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 text-sm border-2 border-gray-200 rounded focus:outline-none focus:border-[#D9591A] transition-colors"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-bold tracking-wide text-gray-700 mb-1.5">
                ...
                <div>
                  ...
                  <select
                    required
                    className="w-full px-4 py-3 text-sm border-2 border-gray-200 rounded focus:outline-none focus:border-[#D9591A] transition-colors bg-white"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 text-sm border-2 border-gray-200 rounded focus:outline-none focus:border-[#D9591A] transition-colors resize-none"
                  />
                </div>
                <button
                  type="submit"
                  disabled={loading}
                  className="inline-block bg-[#D9591A] hover:bg-[#A8400F] disabled:opacity-60 text-white font-bold text-xs tracking-widest px-10 py-4 btn-3d transition-colors self-start"
                >
          ...
          <Reveal direction="left" delay={0.1}>
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="flex items-start gap-4">
                <div className="w-11 h-11 rounded-full bg-[#F5E2CC] flex items-center justify-center flex-shrink-0 mt-0.5">
                  <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="#D9591A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/>
                    <circle cx="12" cy="10" r="3"/>
                  </svg>
                </div>
                <div>
                  <p className="text-xs font-bold tracking-wide text-[#D9591A] uppercase mb-1">Adresse</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-xs font-bold tracking-wide text-[#D9591A] uppercase mb-1">Téléphone</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-xs font-bold tracking-wide text-[#D9591A] uppercase mb-1">Réseaux sociaux</p>
                  <div className="flex gap-3 mt-1">
                    {["Facebook", "LinkedIn", "Twitter"].map((r) => (
                      <a
                        key={r}
                        href="#"
                        className="text-xs text-[#D9591A] hover:underline font-medium"
                      >
                        {r}
                      </a>
                    ))}
            ...
            {/* Bloc adresse visuel */}
            <div className="mt-10 bg-[#2A1812] rounded-lg p-6 text-white">
              <p className="text-xs font-bold tracking-[3px] text-[#F4A906] uppercase mb-3">
                Horaires
              </p>
