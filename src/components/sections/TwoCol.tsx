  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 h-auto md:h-[370px]">
      ...
      <motion.div
        ...
        style={{
          backgroundImage:
            "linear-gradient(135deg, #D9591A 0%, #BE4A18 40%, #C66E2E 70%, #7D1E1E 100%)",
        }}
      ...
      >
        ...
        {!reduce && (
          <>
            <motion.span
              className="absolute -top-8 -left-8 w-40 h-40 rounded-full bg-[#F4A906]/25 blur-2xl"
            ...
            >
              <rect x="8" y="8" width="14" height="32" rx="2" fill="#F4A906" />
              <rect x="24" y="8" width="14" height="32" rx="2" fill="#fff" opacity="0.85" />
              <line x1="23" y1="8" x2="23" y2="40" stroke="#D9591A" strokeWidth="2" />
            </motion.svg>
          </>
        )}
        ...
        <div className="relative z-10 p-8 md:p-10 flex flex-col gap-6 items-start">
          ...
          <Link
            ...
            className="inline-block bg-[#F4A906] hover:bg-white text-gray-900 text-xs font-bold tracking-[2.5px] px-8 py-3.5 btn-3d"
          >
            DÉCOUVRIR
          </Link>
        </div>
      ...
      <motion.div
        ...
        style={{
          background:
            "linear-gradient(rgba(50,40,100,0.65), rgba(80,50,120,0.65)), url('/images/tous_les livres.png') center/cover no-repeat #BE4A18",
        }}
        initial={{ opacity: 0, scale: 1.05 }}
        whileInView={{ opacity: 1, scale: 1 }}
        viewport={{ once: true, amount: 0.3 }}
      ...
      >
        <div className="absolute inset-0 bg-[#F4A906]/0 group-hover:bg-[#F4A906]/10 transition-colors duration-500" />
        <div className="relative z-10 p-8 md:p-10 flex flex-col gap-6 items-start">
          ...
          <Link
            href="/nos-livres"
            className="inline-block bg-white hover:bg-[#F4A906] text-gray-900 text-xs font-bold tracking-[2.5px] px-8 py-3.5 btn-3d"
          >
            DÉCOUVRIR
          </Link>
        </div>
